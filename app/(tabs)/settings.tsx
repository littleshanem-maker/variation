...
export default function SettingsScreen() {
  ...
  connectionBanner: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: colors.successLight, padding: spacing.md, borderRadius: 10, marginBottom: spacing.lg },
  connectionBannerOffline: { backgroundColor: colors.dangerLight },
  connectionText: { fontSize: 13, fontWeight: '500' },
  card: { borderRadius: 10, overflow: 'hidden' as const, borderWidth: 1, borderColor: colors.border, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.07, shadowRadius: 3, elevation: 2 },
  row: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, padding: 16, minHeight: 44 },
