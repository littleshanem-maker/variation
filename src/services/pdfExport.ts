  ...
  const content = `
    <div class="variation-page">
      ...
      <div class="evidence-footer">
        ...
        <div>Generated by Variation Shield &middot; Leveraged Systems</div>
      </div>
    </div>
  `;
...
export function printProjectDetailedWeb(
  ...
  const pages = variations.map((v, i) => `
    <div class="var-page${i > 0 ? ' page-break' : ''}">
      ...
      ` : ''}
      <div class="var-footer">Leveraged Systems · Variation Shield · Generated ${now}</div>
    </div>
  `).join('\n');
...
<body>
  ...
  <!-- COVER PAGE -->
  <div class="cover">
    <div class="cover-brand">Leveraged Systems · Variation Shield</div>
...
<body>
  ...
  <div class="evidence-footer">
    ...
    <div class="footer-brand">
      <span>Leveraged Systems · Variation Shield</span>
