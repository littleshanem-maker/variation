      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        {role !== 'field' && (
          <>
            ...
            <Link
              href="/variation/new"
              className="flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-medium text-[#FFFCF5] bg-[#E76F00] border border-[#E76F00] hover:bg-[#C75A00] hover:border-[#C75A00] hover:-translate-y-px transition-all shadow-[0_1px_2px_rgba(17,24,39,0.08)]"
            >
              <Plus size={15} strokeWidth={2.5} />
              New request
            </Link>
