  ...
  return (
    <div className="min-h-screen bg-[#1a2338] text-white">
      ...
      <div className="max-w-lg mx-auto px-6 py-12">
        ...
        {/* Header */}
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 bg-[#E76F00]/10 border border-[#E76F00]/20 rounded-full px-3 py-1 text-xs font-semibold text-[#E76F00] mb-4">
            📱 Quick Setup
          </div>
        ...
        <div className="mb-8">
          ...
          <ol className="space-y-5">
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-6 text-lg font-black text-[#E76F00] leading-none pt-0.5">1</span>
              <div>
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-6 text-lg font-black text-[#E76F00] leading-none pt-0.5">2</span>
              <div>
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-6 text-lg font-black text-[#E76F00] leading-none pt-0.5">3</span>
              <div>
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-6 text-lg font-black text-[#E76F00] leading-none pt-0.5">4</span>
              <div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 text-center">
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 bg-[#E76F00] hover:bg-[#E76F00] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors"
          >
