    ...
    <main className="min-h-screen bg-[#F5F2EA] text-[#111827] flex items-center justify-center px-6 py-16">
      <div className="max-w-xl text-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center bg-[#E76F00] hover:bg-[#C75A00] text-[#FFFCF5] font-medium px-8 py-4 rounded-md text-[16px] transition-colors shadow-lg shadow-[#E76F00]/25"
        >
          Open demo request
        </button>
