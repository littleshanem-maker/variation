...
export default function MobileNav() {
  ...
  return (
    <div id="mobile-nav" className="hidden md:hidden fixed top-[64px] left-0 right-0 z-50 bg-[#FFFCF5] border-b border-[#D8D2C4] flex flex-col py-2 px-6 gap-0 shadow-xl">
      ...
      <DemoButton className="my-3 w-full text-center bg-[#E76F00] hover:bg-[#C75A00] text-[#FFFCF5] text-sm font-medium px-4 py-3 rounded-md">Book a 10-minute demo</DemoButton>
