    ...
    <div id="top" className="min-h-screen bg-[#F5F2EA] text-[#111827] font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-[#FFFCF5]/95 border-b border-[#D8D2C4] shadow-[0_1px_2px_rgba(17,24,39,0.06)]">
        <a href="https://variationshield.com.au" className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-[15px] tracking-tight text-[#111827]">Variation Shield</span>
        </a>
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-40 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-[#FFFCF5] border border-[#D8D2C4] rounded-sm px-3 py-1.5 text-xs font-semibold text-[#C75A00] uppercase tracking-widest mb-8">
          ...
          <p className="mt-5 text-sm text-[#334155]">
            Founder-led setup · 30-day live-job pilot · <span className="text-[#D99A00]">$299/mo early adopter rate</span>
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-3">Sound familiar?</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={p.n} className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
                <div className="text-5xl font-bold text-[#E76F00]/25 mb-4 leading-none">{p.n}</div>
      ...
      <section className="py-24 px-6 bg-[#FFFCF5] border-y border-[#D8D2C4]" id="how-it-works">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-3">The system</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              ...
              <p className="text-sm font-bold tracking-[0.055em] uppercase text-[#C75A00] mb-3">Step 01</p>
              <h3 className="text-base font-bold mb-3">Capture on site</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">Open the app. Add photos, description, cost and time impact. Under 60 seconds. Works offline — syncs when back in range.</p>
            </div>
            {/* Step 2 */}
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-md bg-[#E76F00]/15 border border-[#E76F00]/20 flex items-center justify-center mb-6">
              ...
              <p className="text-sm font-bold tracking-[0.055em] uppercase text-[#C75A00] mb-3">Step 02</p>
              <h3 className="text-base font-bold mb-3">Send to your client</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">Generate a professional PDF and send it directly from the app. The client approves or rejects via a secure link — no phone calls needed.</p>
            </div>
            {/* Step 3 */}
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-md bg-[#E76F00]/15 border border-[#E76F00]/20 flex items-center justify-center mb-6">
              ...
              <p className="text-sm font-bold tracking-[0.055em] uppercase text-[#C75A00] mb-3">Step 03</p>
              <h3 className="text-base font-bold mb-3">Track to payment</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">Every variation tracked from draft to approved to paid. Your PM sees everything in real time. No chasing. No arguing at final account.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6" id="features">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-3">Features</p>
      ...
      <section className="py-24 px-6 bg-[#FFFCF5] border-y border-[#D8D2C4]">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-6">Why this exists</p>
      ...
      <section className="py-20 px-6 bg-[#FFFCF5] border-y border-[#D8D2C4]">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-3">Founder-led onboarding</p>
      ...
      <section className="py-24 px-6" id="pricing">
        <div className="max-w-lg mx-auto text-center">
          <p className="text-[#E76F00] text-xs font-bold tracking-[0.055em] uppercase mb-3">Pricing</p>
          ...
          <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-left relative overflow-hidden">
            ...
            <p className="text-[#D99A00]/80 text-sm font-semibold mb-1">$299/month early adopter rate, locked for 12 months</p>
            <p className="text-[#334155] text-xs mb-1">First 10 customers: $299/month. Standard price will be $499/month.</p>
            <p className="text-[#64748B] text-xs mb-8">If it helps, continue at the $299/month early adopter rate. Cancel anytime.</p>
      ...
      <footer className="border-t border-[#D8D2C4] px-6 py-8">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#64748B]">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-[#334155]">Variation Shield</span>
