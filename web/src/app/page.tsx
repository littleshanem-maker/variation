    ...
    <div id="top" className="min-h-screen bg-[#F5F2EA] text-[#111827] font-sans">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-40 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <DemoButton className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#E76F00] hover:bg-[#C75A00] text-[#FFFCF5] font-medium px-8 py-4 rounded-md text-base transition-colors shadow-[0_2px_4px_rgba(17,24,39,0.12)]">
              Book a 15-minute demo
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">Open the app. Add photos, description, cost and time impact. Under 60 seconds. Works offline — syncs when back in range.</p>
            </div>
            {/* Step 2 */}
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-md bg-[#E76F00]/15 border border-[#E76F00]/20 flex items-center justify-center mb-6">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">Generate a professional PDF and send it directly from the app. The client approves or rejects via a secure link — no phone calls needed.</p>
            </div>
            {/* Step 3 */}
            <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-md bg-[#E76F00]/15 border border-[#E76F00]/20 flex items-center justify-center mb-6">
              ...
              <p className="text-[#6B7280] text-sm leading-relaxed">Every variation tracked from draft to approved to paid. Your PM sees everything in real time. No chasing. No arguing at final account.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-[#FFFCF5] border-y border-[#D8D2C4]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <DemoButton className="inline-flex items-center justify-center gap-2 bg-[#E76F00] hover:bg-[#C75A00] text-[#FFFCF5] font-medium px-8 py-4 rounded-md text-base transition-colors shadow-[0_2px_4px_rgba(17,24,39,0.12)]">
            Book a 15-minute demo
            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </DemoButton>
        </div>
      ...
      <section className="py-24 px-6" id="pricing">
        <div className="max-w-lg mx-auto text-center">
          ...
          <div className="bg-[#FFFCF5] border border-[#D8D2C4] rounded-md p-8 text-left relative overflow-hidden">
            ...
            <div className="inline-flex items-center gap-1.5 bg-[#D99A00]/10 border border-[#D99A00]/25 rounded-sm px-3 py-1 text-xs font-medium text-[#D99A00] uppercase tracking-wider mb-5">
              First 10 customers
            </div>
            ...
            <p className="text-[#D99A00]/80 text-sm font-medium mb-1">$299/month early adopter rate, locked for 12 months</p>
            <p className="text-[#334155] text-xs mb-1">First 10 customers: $299/month. Standard price will be $499/month.</p>
            <p className="text-[#6B7280] text-xs mb-8">If it helps, continue at the $299/month early adopter rate. Cancel anytime.</p>
            ...
            <DemoButton className="flex items-center justify-center gap-2 w-full bg-[#E76F00] hover:bg-[#C75A00] text-[#FFFCF5] font-medium py-4 rounded-md text-base transition-colors shadow-[0_2px_4px_rgba(17,24,39,0.12)]">
              Book a 15-minute demo
              <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </DemoButton>
            <p className="text-center text-[#6B7280] text-xs mt-3">If Variation Shield does not help you capture more than $299 of variation value in the first 30 days, we’ll refund the pilot fee.</p>
          </div>
